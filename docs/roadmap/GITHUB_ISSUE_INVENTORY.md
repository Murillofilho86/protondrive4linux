...
| M2-001 | Release signing | M2 | `type:security` `area:security` `priority:critical` | 🔶 (chave gerada, secrets configurados, falta ligar `RELEASE_SIGNING_READY` e a 1ª tag assinada) |
